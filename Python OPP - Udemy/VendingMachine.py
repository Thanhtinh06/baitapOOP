class VendingMachine:
    ...
    snack_prices = {"candy": 2.00, "soda": 1.50,
                    "chips": 3.00, "cookies": 3.50}
    ...
    def __init__(self, inventory, serial, days_until_maintenance):
        ...
        # Initially, when an instance of the vending machine is created, the revenue is 0 and it's updated with each sale.
        self.revenue = 0
        self.serial = serial
    ...
    def sales_menu(self):
        ...
        while True:
            ...
            self.process_sale(list(self.inventory.keys())
                              [cust_input - 1].lower())
            answer = int(
    ...
    def process_sale(self, option):  # option must be in lowercase
        ...
        if self.inventory[option] > 0:
            ...
            num_items = int(
                input("How many %s would you like to buy?\n" % option))
...
class HospitalVendingMachine(VendingMachine):
    ...
    # Complete the class
    snack_prices = {"candy": 3.00, "soda": 2.0,
                    "chips": 4.00, "cookies": 5.0}
    ...
    def print_days_until_maintenance(self):
        print(f" We have {self.days_until_maintenance} days to maintain")
...
class SchoolVendingMachine(VendingMachine):
    ...
    snack_prices = {"candy": 2.00, "soda": 1.5,
                    "chips": 3.00, "cookies": 3.5}

    student_debt = {"Hellen": 4.00, "Mark": 9.00,
                    "Jone": 7.00, "Jun": 6.00}
    ...
    def print_student_debt(self):
        name_student = input("Type your name: ")
        if name_student in self.student_debt.keys():
            print(
                f"Hello {name_student}, your debt is: {self.student_debt[name_student]}")
        else:
            print("You don't have debt")
        # Instances =============================================================================================


floor_machine = VendingMachine(
    {"candy": 36, "soda": 15, "chips": 40, "cookies": 120}, "011423424", 24)
floor_machine.sales_menu()

hospital_machine = HospitalVendingMachine(
    {"candy": 32, "soda": 50, "chips": 45, "cookies": 80}, "03223424", 15)
hospital_machine.sales_menu()
hospital_machine.print_days_until_maintenance()

school_machine = SchoolVendingMachine(
    {"candy": 36, "soda": 15, "chips": 40, "cookies": 120}, "0534424", 2)
school_machine.sales_menu()
school_machine.print_student_debt()
